                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: EditableTextField.text(
                              ...
                              helperToolbarKey: ValueKey('palEditorSimpleHelperWidgetToolbar'),
                              ...
                              backgroundBoxDecoration: BoxDecoration(
                                color: viewModel?.bodyBox?.backgroundColor?.value ?? PalTheme.of(context).colors.light,
                              ...
                              textStyle: TextStyle(
                                  ...
                                  fontSize: viewModel.detailsField?.fontSize?.value?.toDouble(),
                                  fontWeight: FontWeightMapper.toFontWeight(viewModel.detailsField?.fontWeight?.value,
                                ),
                              ).merge(
                                _googleCustomFont(
                  ...
                  Positioned(
                    ...
                    child: SafeArea(
                      child: CircleIconButton(
                        key: ValueKey('pal_EditorSimpleHelperWidget_CircleBackground'),
