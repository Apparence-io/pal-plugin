...
class HelperDetailsComponent extends StatelessWidget
  ...
  HelperDetailsComponent(
      {Key key, @required this.helper, this.testHelperService})
      : super(key: key);
      ...
      AppBar(
        ...
        actions: [
          FlatButton(
              ...
              onPressed: presenter.deleteHelper,
  ...
  _buildBody(BuildContext context, HelperDetailsModel model) => Column(
        children: [
          _buildLine(
              ...
              '${model.helperMinVer} - ${model.helperMaxVer}',
              context,
              ValueKey('versions')),
          _buildLine(
              'Trigger mode',
  ...
  _buildLine(
    ...
    TextStyle textStyle = TextStyle(color: PalTheme.of(context).colors.color1);
    return DecoratedBox(
      decoration: BoxDecoration(
          border: Border(
              bottom: BorderSide(color: PalTheme.of(context).colors.color1))),
      child: Padding(
