  ...
  group('[HelperClientService] getPageNextHelper', () {
    ...
    setUp(() async{
      ...
      var schema = SchemaEntity(
        ...
        groups: [
          HelperGroupEntity(id: "g1", triggerType: HelperTriggerType.ON_SCREEN_VISIT, priority: 1, page: PageEntity(id: 'p1', route: 'route1'), helpers: [HelperEntity(id: "1")]),
          HelperGroupEntity(id: "g2", triggerType: HelperTriggerType.ON_SCREEN_VISIT, priority: 2, page: PageEntity(id: 'p1', route: 'route1'), helpers: [HelperEntity(id: "2")]),
          HelperGroupEntity(id: "g3", triggerType: HelperTriggerType.ON_NEW_UPDATE, priority: 1, page: PageEntity(id: 'p2', route: 'route2'), helpers: [HelperEntity(id: "3")]),
          HelperGroupEntity(id: "g4", triggerType: HelperTriggerType.ON_SCREEN_VISIT, priority: 2, page: PageEntity(id: 'p2', route: 'route2'), helpers: [HelperEntity(id: "4")]),
          HelperGroupEntity(id: "g5", triggerType: HelperTriggerType.ON_NEW_UPDATE, priority: 3, page: PageEntity(id: 'p2', route: 'route2'), helpers: [HelperEntity(id: "5")]),
          HelperGroupEntity(id: "g6", triggerType: HelperTriggerType.ON_SCREEN_VISIT, priority: 1, page: PageEntity(id: 'p3', route: 'route3'), helpers: [HelperEntity(id: "3")]),
          HelperGroupEntity(id: "g7", triggerType: HelperTriggerType.ON_NEW_UPDATE, priority: 1, page: PageEntity(id: 'p3', route: 'route3'), helpers: [HelperEntity(id: "5")]),
        ],
        schemaVersion: 1
      );
