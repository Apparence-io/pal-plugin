...
void main() {
  group('Test in app user service', () {
    ...
    test('Test get and create in app user => in app user doesn\'t exists', () async {
      ...
      when(httpClient.post("pal-analytic/in-app-users", body: expectedBody)).thenAnswer((_) => Future.value(Response(content, 200)));
    ...
    test('Test on connect => anonymous', () async {
      ...
      when(httpClient.put("pal-analytic/in-app-users/db6b01e1-b649-4a17-949a-9ab320601001", body: expectedBody)).thenAnswer((_) => Future.value(Response(content, 200)));
