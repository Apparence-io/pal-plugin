...
void main() {
  ...
  testWidgets('loading with error => shut silently with a message', (WidgetTester tester) async {
    when(httpClientMock.get('pal-business/editor/groups?routeName=myPage'))
  ...
  testWidgets('click add helper button => show create helper page', (WidgetTester tester) async {
    ...
    var createHelperButton = find.byType(CreateHelperButton).evaluate().first.widget as CreateHelperButton;
